    ...
    <div className="min-h-screen bg-white p-6">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <Card className="p-6 bg-gradient-to-r from-km0-blue-50 to-km0-beige-50 border-km0-blue-200">
          <h3 className="font-brand text-2xl font-semibold mb-4 text-km0-blue-700">Colores del Sistema</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="text-center space-y-2">
              <div className="size-16 bg-km0-blue-700 rounded-lg mx-auto border border-km0-blue-300"></div>
            ...
            <div className="text-center space-y-2">
              <div className="size-16 bg-km0-beige-100 rounded-lg mx-auto border border-km0-beige-300"></div>
              <div className="caption text-neutral-700">
            ...
            <div className="text-center space-y-2">
              <div className="size-16 bg-km0-coral-400 rounded-lg mx-auto border border-km0-coral-300"></div>
              <div className="caption text-neutral-700">
            ...
            <div className="text-center space-y-2">
              <div className="size-16 bg-km0-yellow-500 rounded-lg mx-auto border border-km0-yellow-300"></div>
              <div className="caption text-neutral-700">
